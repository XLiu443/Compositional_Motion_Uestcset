...
#from src.config import Pretrained_PATH
...
def add_model_options(parser):
    ...
    group.add_argument("--lambda_mae", default=0.01, type=float, help="weight of the rc divergence loss")
    group.add_argument("--jointstype", default="vertices", choices=JOINTSTYPES, help="Jointstype for training with xyz")
    group.add_argument("--resume1", action='store_true')
    group.add_argument("--resume2", action='store_true')
